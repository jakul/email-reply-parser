...
class NHSNETEmailMessage(EmailMessage):
    ...
    SIG_REGEX = r'--|__|-\w|^Sent from my (\w+\s*){1,3}|^Sent from Samsung Mobile|^[*][*][*][*][*][*][*][*][*]+$|^[\w ]*[Rr]egards[,]?$|^[\w ]*[Tt]hanks[,]?$|This email is intended for the addressee\(s\) named above|This email is confidential and may also be privileged. If you are not the i|E-MAIL DISCLAIMER - IMPORTANT INFORMATION|Lilyville Surgery, 630 Fulham Road, London SW6 5RS|Tel 020 7731 5130, 020 7731 9388(direct line)|Fax 020 7736 4985'
